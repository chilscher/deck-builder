...
public class Catalog : MonoBehaviour {
    ...
    public enum EffectTypes { Damage, Shield, Vulnerable }; //to add new effect types, add a new element in this EffectType list. To implement its effect, add a new switch case in DisplayCard.DoCardEffect
